...
async function send(sendInfo) {
  ...
  let info = await transporter.sendMail({
    from: '"认证邮件" <994216624@qq.com>', // sender address
    to: sendInfo.email, // list of receivers
    subject: sendInfo.user !== '' ? `你好开发者，${sendInfo.user}` : '注册码', // Subject line
    ...
    <div style="height: 60px; background: #393d49; line-height: 60px; color: #58a36f; font-size: 18px;padding-left: 10px;">社区——欢迎来到官方社区</div>
